...
export const endpoints = {
  ...
  genus: {
    ...
    create: '/api/v1/genera',
    update: (id) => `/api/v1/genera/${id}`,
    delete: (id) => `/api/v1/genera/${id}`,
  },
  species: {
    list: '/api/v1/species',
    details: (id) => `/api/v1/species/${id}`,
  ...
  morph: {
    list: '/api/v1/morphs',
    details: (id) => `/api/v1/morphs/${id}`,
    create: '/api/v1/morphs',
    update: (id) => `/api/v1/morphs/${id}`,
    delete: (id) => `/api/v1/morphs/${id}`,
  },
  animal: {
    list: '/api/v1/animals',
    details: (id) => `/api/v1/animals/${id}`,
    create: '/api/v1/animals',
